...
## Identity
- **Name:** Prasham Tated
- **Location:** Omonoias 63, Limassol, Cyprus 3052
...
|--------|--------|-------------|------------|
| Bachelor of Engineering (Information Technology) | 2007-2011 | Amravati University (SGBAU), Maharashtra, India | [TOPICS] |
...
- Designed and developed over 5 innovative Android applications that enhanced user experience by streamlining navigation and functionality, resulting in a 30% increase in user engagement metrics.
- Provided comprehensive end-to-end support for application deployment and maintenance processes, ensuring a seamless transition from development to production environments with zero downtime.
- Collaborated with cross-functional teams of designers and product managers to integrate new features and updates into existing applications, improving overall project delivery timelines by 25%.

## Additional
- Global exposure: 7 years based in Cyprus, Europe, with onsite delivery and knowledge-transfer experience across India and European client teams.
